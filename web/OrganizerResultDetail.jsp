...
<%
    ...
    for (Match match : allMatches) {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            if (t1Score != null && t2Score != null) {
                ...
                if (t1Score > t2Score) team1Sets++;
                else if (t2Score > t1Score) team2Sets++;
            }
        }
    ...
    for (Match m : bracketMatches) {
        if ("Final".equals(m.getGroupName())) finalMatch = m;
        else if ("SF1".equals(m.getGroupName())) sf1 = m;
        else if ("SF2".equals(m.getGroupName())) sf2 = m;
    }
...
<head>
    ...
    <style>
        ...
        .results-section { padding: 2rem 0; background-color: #f8f9fa; min-height: 80vh; }
        .page-title { font-size: 2.5rem; color: #1a1a2e; text-align: center; margin-bottom: 1rem; font-weight: 800; }
                        ...
                        <% 
                            ...
                            Collections.sort(allTeams, new Comparator<TeamRegistration>() {
                                public int compare(TeamRegistration t1, TeamRegistration t2) {
                                    ...
                                    if (wins1 != wins2) return wins2 - wins1;
