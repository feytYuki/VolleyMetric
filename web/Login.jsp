...
<head>
    ...
    <title>Login - VolleyMetric</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="auth-container">
            <div class="auth-card">
                <div class="auth-header">
                    ...
                    <p class="auth-subtitle">Login to your VolleyMetric account</p>
                </div>
                ...
                <form action="LoginUser" method="POST" class="auth-form">
                ...
                <div class="auth-footer">
                    <p class="auth-text">
                        ...
                        <a href="Register.jsp" class="auth-link">Register here</a>
                    </p>
                    <p class="auth-text" style="margin-top: 1rem;">
                        Are you an organizer? 
                        <a href="OrganizerLogin.jsp" class="auth-link">Organizer Login</a>
                    </p>
                </div>
            </div>
        </div>
