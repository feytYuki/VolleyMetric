    ...
    <section class="results-section">
        <div class="container">
            <div class="page-header">
                ...
                <p class="page-subtitle">View rankings and outcomes of completed tournaments</p>
            </div>
            
            <% if (completedTournaments.isEmpty()) { %>
                <div class="empty-state">
                    <h3>📋 No Completed Tournaments Yet</h3>
                    <p>Check back later for tournament results and rankings.</p>
                </div>
            <% } else { %>
                <div class="tournaments-grid">
                    <% for (Tournament tournament : completedTournaments) { %>
                    <div class="tournament-card">
                        ...
                        <div class="tournament-body">
                            ...
                            <a href="UserResultDetail.jsp?id=<%= tournament.getTournamentId() %>" class="btn-action">View Full Results</a>
                        </div>
                    </div>
                    <% } %>
                </div>
