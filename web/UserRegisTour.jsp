...
<head>
    ...
    <style>
        ...
        .header-completed{ background: linear-gradient(135deg, #4ecdc4, #2eaaa1); }
        ...
        .badge-approved  { background: linear-gradient(135deg, #2ecc71, #27ae60); }
        .badge-rejected  { background: linear-gradient(135deg, #e74c3c, #c0392b); }
        ...
        .team-display { color: #ff6b6b; font-weight: 700; font-size: 1.1rem; margin-bottom: 1.5rem; display: block; text-align: center; }
        .card-completed .team-display { color: #2eaaa1; }
        ...
        .btn-action { background: linear-gradient(135deg, #ff6b6b, #ee5a52); color: white; padding: 0.8rem; border: none; border-radius: 8px; font-weight: 700; cursor: pointer; width: 100%; transition: all 0.3s; text-decoration: none; display: block; text-align: center; margin-top: 0.5rem; }
        .btn-action:hover { transform: translateY(-3px); box-shadow: 0 4px 12px rgba(255,107,107,0.3); }
        .btn-blue    { background: linear-gradient(135deg, #667eea, #5a6fd8); }
        .btn-teal    { background: linear-gradient(135deg, #4ecdc4, #2eaaa1); }
        .btn-results { background: linear-gradient(135deg, #f7971e, #ffd200); color: #1a1a2e; }
        .btn-results:hover { box-shadow: 0 4px 12px rgba(247,151,30,0.4); }

        .empty-state { text-align: center; padding: 4rem; background: white; border-radius: 20px; }
        .empty-state h2 { font-size: 1.5rem; color: #1a1a2e; margin-bottom: 0.5rem; }
