...
<%
    // Fetch the 3 newest tournaments for the public homepage
...
<html lang="en">
    <head>
        ...
        <title>Volleyball Tournament Management System</title>
    ...
    <body>
        ...
        <section class="hero" style="padding: 4rem 0;">
            <div class="container">
                <div class="hero-content">
                    <h1 class="hero-title">Manage Your Volleyball Tournaments with Ease</h1>
                    <p class="hero-subtitle">Complete tournament management solution for organizing, scheduling, and tracking volleyball competitions</p>
                    <div class="hero-buttons">
                        <a href="Login.jsp" class="btn btn-large btn-primary">Create Tournament</a>
                        <a href="Login.jsp" class="btn btn-large btn-outline-white">Explore Tournaments</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="slideshow-section">
            <div class="slideshow-wrapper">
                <div class="slideshow-track" id="slideshowTrack">
                    <!-- Slide 1 - action photo: use cover to fill wide frame -->
                    <div class="slide">
                    ...
                    <!-- Slide 2 - poster/banner: use contain so text isn't cropped -->
                    <div class="slide">
                    ...
                    <!-- Slide 3 - poster/banner: use contain so text isn't cropped -->
                    <div class="slide">
        ...
        <style>
            ...
            /* Slide 1 action photo: zoom out to show full image */
            .slide-img-cover {
                object-fit: contain;
                object-position: center center;
                background: #0d1b2a;
            }
            /* Poster/banner images: show the full image without cropping */
            .slide-img-contain {
                object-fit: contain;
                object-position: center center;
                background: #0a0a1a;
            ...
            /* Hide caption on contain slides so it doesn't cover the poster text */
        ...
        <!-- Features Section -->
        <section class="features" style="padding: 5rem 0; background: linear-gradient(160deg, #0f0c29, #302b63, #24243e);">
            <div class="container">
                <div style="text-align:center; margin-bottom: 3.5rem;">
                    <span style="display:inline-block; background: rgba(102,126,234,0.2); color: #a78bfa; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; padding: 6px 18px; border-radius: 50px; border: 1px solid rgba(102,126,234,0.35); margin-bottom: 1rem;">Platform Capabilities</span>
                    <h2 style="font-size: 2.6rem; font-weight: 800; color: #fff; margin: 0 0 1rem;">Everything you need to run a tournament</h2>
                    <p style="color: rgba(255,255,255,0.55); font-size: 1.05rem; max-width: 560px; margin: 0 auto; line-height: 1.7;">From bracket generation to final reports — VolleyMetric handles every stage of your competition.</p>
                </div>

                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem;">

                    <!-- Card 1 -->
                    <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 20px; padding: 2rem 1.75rem; transition: transform 0.3s, box-shadow 0.3s; position: relative; overflow: hidden;"
                         onmouseover="this.style.transform='translateY(-6px)'; this.style.boxShadow='0 20px 40px rgba(0,0,0,0.4)'"
                         onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                        <div style="position:absolute; top:-30px; right:-30px; width:120px; height:120px; background: radial-gradient(circle, rgba(102,126,234,0.2), transparent 70%); border-radius:50%;"></div>
                        <div style="width:52px; height:52px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.5rem; margin-bottom:1.4rem; box-shadow: 0 8px 20px rgba(102,126,234,0.4);">🪄</div>
                        <h3 style="font-size:1.15rem; font-weight:700; color:#fff; margin:0 0 0.75rem;">Bracket &amp; Group Generation</h3>
                        <p style="font-size:0.92rem; color:rgba(255,255,255,0.55); line-height:1.7; margin:0 0 1.5rem;">Auto-generate knockout brackets or round-robin groups the moment a tournament starts.</p>
                        <div style="display:flex; align-items:center; gap:6px; color:#a78bfa; font-size:0.82rem; font-weight:600;">
                            <span style="width:20px; height:2px; background:#a78bfa; border-radius:2px; display:inline-block;"></span> For Organizers
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 20px; padding: 2rem 1.75rem; transition: transform 0.3s, box-shadow 0.3s; position: relative; overflow: hidden;"
                         onmouseover="this.style.transform='translateY(-6px)'; this.style.boxShadow='0 20px 40px rgba(0,0,0,0.4)'"
                         onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                        <div style="position:absolute; top:-30px; right:-30px; width:120px; height:120px; background: radial-gradient(circle, rgba(64,224,176,0.2), transparent 70%); border-radius:50%;"></div>
                        <div style="width:52px; height:52px; background: linear-gradient(135deg, #11998e, #38ef7d); border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.5rem; margin-bottom:1.4rem; box-shadow: 0 8px 20px rgba(17,153,142,0.4);">📋</div>
                        <h3 style="font-size:1.15rem; font-weight:700; color:#fff; margin:0 0 0.75rem;">Online Team Registration</h3>
                        <p style="font-size:0.92rem; color:rgba(255,255,255,0.55); line-height:1.7; margin:0 0 1.5rem;">Teams apply with full rosters — captain details, player positions, jersey numbers — all in one form.</p>
                        <div style="display:flex; align-items:center; gap:6px; color:#38ef7d; font-size:0.82rem; font-weight:600;">
                            <span style="width:20px; height:2px; background:#38ef7d; border-radius:2px; display:inline-block;"></span> For Players
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 20px; padding: 2rem 1.75rem; transition: transform 0.3s, box-shadow 0.3s; position: relative; overflow: hidden;"
                         onmouseover="this.style.transform='translateY(-6px)'; this.style.boxShadow='0 20px 40px rgba(0,0,0,0.4)'"
                         onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                        <div style="position:absolute; top:-30px; right:-30px; width:120px; height:120px; background: radial-gradient(circle, rgba(245,158,11,0.2), transparent 70%); border-radius:50%;"></div>
                        <div style="width:52px; height:52px; background: linear-gradient(135deg, #f093fb, #f5a623); border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.5rem; margin-bottom:1.4rem; box-shadow: 0 8px 20px rgba(245,166,35,0.4);">🗓️</div>
                        <h3 style="font-size:1.15rem; font-weight:700; color:#fff; margin:0 0 0.75rem;">Live Schedule &amp; Match Tracking</h3>
                        <p style="font-size:0.92rem; color:rgba(255,255,255,0.55); line-height:1.7; margin:0 0 1.5rem;">View real-time match schedules, court assignments, set scores, and group standings throughout the event.</p>
                        <div style="display:flex; align-items:center; gap:6px; color:#f5a623; font-size:0.82rem; font-weight:600;">
                            <span style="width:20px; height:2px; background:#f5a623; border-radius:2px; display:inline-block;"></span> Live Updates
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 20px; padding: 2rem 1.75rem; transition: transform 0.3s, box-shadow 0.3s; position: relative; overflow: hidden;"
                         onmouseover="this.style.transform='translateY(-6px)'; this.style.boxShadow='0 20px 40px rgba(0,0,0,0.4)'"
                         onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                        <div style="position:absolute; top:-30px; right:-30px; width:120px; height:120px; background: radial-gradient(circle, rgba(239,68,68,0.2), transparent 70%); border-radius:50%;"></div>
                        <div style="width:52px; height:52px; background: linear-gradient(135deg, #fc5c7d, #6a3093); border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.5rem; margin-bottom:1.4rem; box-shadow: 0 8px 20px rgba(252,92,125,0.4);">📑</div>
                        <h3 style="font-size:1.15rem; font-weight:700; color:#fff; margin:0 0 0.75rem;">Reports &amp; Export</h3>
                        <p style="font-size:0.92rem; color:rgba(255,255,255,0.55); line-height:1.7; margin:0 0 1.5rem;">Generate tournament summaries, team standings, and player rosters — export to CSV or PDF instantly.</p>
                        <div style="display:flex; align-items:center; gap:6px; color:#fc5c7d; font-size:0.82rem; font-weight:600;">
                            <span style="width:20px; height:2px; background:#fc5c7d; border-radius:2px; display:inline-block;"></span> For Organizers
                        </div>
                    </div>
        ...
        <section style="padding: 5rem 0; background: linear-gradient(160deg, #0f2027, #1a1a3e, #16213e);">
            <div class="container">
                ...
                <!-- Section header — mirrors Features -->
                <div style="text-align:center; margin-bottom: 3.5rem;">
                    ...
                    <h2 style="font-size: 2.6rem; font-weight: 800; color: #fff; margin: 0 0 1rem;">Recent Tournaments</h2>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
                    ...
                    <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 20px; padding: 2rem 1.75rem; transition: transform 0.3s, box-shadow 0.3s; position: relative; overflow: hidden; display: flex; flex-direction: column; gap: 0;"
                        ...
                        <div style="display:flex; align-items:center; justify-content:space-between; border-top: 1px solid rgba(255,255,255,0.08); padding-top:1.2rem; margin-top:auto;">
                            <a href="Login.jsp" style="display:inline-flex; align-items:center; gap:6px; background: <%= iconGrad %>; color:#fff; font-size:0.85rem; font-weight:600; padding: 9px 20px; border-radius:10px; text-decoration:none; transition: opacity 0.2s; box-shadow: 0 4px 14px <%= iconBg %>;"
                ...
                <div style="text-align:center; margin-top:2.5rem;">
                    <a href="Login.jsp" style="display:inline-flex; align-items:center; gap:8px; color:rgba(255,255,255,0.6); font-size:0.92rem; font-weight:600; text-decoration:none; border: 1px solid rgba(255,255,255,0.15); padding: 10px 28px; border-radius:50px; transition: all 0.2s;"
