...
<%
    ...
    Map<Integer, Integer> teamLosses = new HashMap<>();
    Map<Integer, Integer> setsWon = new HashMap<>();
    Map<Integer, Integer> setsLost = new HashMap<>();
    Map<Integer, Integer> pointsScored = new HashMap<>();
    Map<Integer, Integer> pointsConceded = new HashMap<>();
            ...
            <div class="container">
                ...
                <nav class="nav">
                    <ul class="nav-list">
                        ...
                        <li><a href="UserResult.jsp" class="nav-link active">Results</a></li>
                    </ul>
                </nav>
                    ...
                    <table>
                        ...
                        <tbody>
                            <%
                                ...
                                // Make these final for use in Comparator
                                final Map<Integer, Integer> finalTeamWins = teamWins;
                                final Map<Integer, Integer> finalSetsWon = setsWon;
                                final Map<Integer, Integer> finalPointsScored = pointsScored;

                                Collections.sort(allTeams, new Comparator<TeamRegistration>() {
                                    public int compare(TeamRegistration t1, TeamRegistration t2) {
                                        int wins1 = finalTeamWins.getOrDefault(t1.getRegistrationId(), 0);
                                        int wins2 = finalTeamWins.getOrDefault(t2.getRegistrationId(), 0);
                                        if (wins1 != wins2) {
                                            return wins2 - wins1;
                                        }

                                        int sets1 = finalSetsWon.getOrDefault(t1.getRegistrationId(), 0);
                                        int sets2 = finalSetsWon.getOrDefault(t2.getRegistrationId(), 0);
                                        if (sets1 != sets2) {
                                            return sets2 - sets1;
                                        }

                                        int points1 = finalPointsScored.getOrDefault(t1.getRegistrationId(), 0);
                                        int points2 = finalPointsScored.getOrDefault(t2.getRegistrationId(), 0);
