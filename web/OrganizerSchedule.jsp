...
<%
    ...
    // Fetch tournaments that have begun (status = ongoing) for this organizer
    ...
    try {
        ...
        String sql = "SELECT tournament_id, tournament_name, location, tournament_date, start_time, max_teams, current_teams " +
                     "FROM tournaments " +
...
<head>
    ...
    <style>
        ...
        .schedule-section { padding: 4rem 0; background-color: #f8f9fa; min-height: 80vh; }
        ...
        /* --- HEADER STYLES (Matching UserSchedule) --- */
        .tournament-header {
        ...
        .info-item { display: flex; align-items: center; gap: 0.8rem; color: #555; padding: 0.5rem; background: #f8f9fa; border-radius: 8px; margin-bottom: 0.5rem; font-size: 0.95rem; }
        ...
        .no-tournaments { text-align: center; padding: 4rem 2rem; background: white; border-radius: 20px; box-shadow: 0 8px 30px rgba(0,0,0,0.1); }
        .no-tournaments h3 { font-size: 1.8rem; color: #2c3e50; margin-bottom: 1rem; }
        .no-tournaments p { color: #6c757d; font-size: 1.1rem; }
        
        .alert { padding: 1rem; border-radius: 8px; margin-bottom: 2rem; font-size: 0.95rem; display: flex; align-items: center; gap: 0.5rem; text-align: center; justify-content: center;}
    ...
    <section class="schedule-section">
        <div class="container">
            ...
            <div class="page-header">
                ...
                <p class="page-subtitle">Manage ongoing tournaments and create match schedules</p>
            </div>

            <% if (ongoingTournaments.isEmpty()) { %>
                <div class="no-tournaments">
                    <h3>📅 No Ongoing Tournaments</h3>
                    <p>You don't have any ongoing tournaments at the moment.</p>
                    <p style="margin-top: 1rem;">Start a tournament from the tournament details page to see it here.</p>
                </div>
            <% } else { %>
                    ...
                    <div class="tournament-card">
                        ...
                        <div class="tournament-body">
                            <div class="tournament-info">
                                ...
                                <div class="info-item"><span>👥 <strong>Teams:</strong> <%= tournament.get("currentTeams") %>/<%= tournament.get("maxTeams") %> Teams</span></div>
                            </div>
                            <a href="TournamentScheduleDetail.jsp?id=<%= tournament.get("id") %>" class="btn-action">
                                ▶️ Begin Schedule
                            </a>
                        </div>
                    </div>
