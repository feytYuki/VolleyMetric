...
<head>
    ...
    <title>Register - VolleyMetric</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="auth-container">
            <div class="auth-card">
                <div class="auth-header">
                    ...
                    <p class="auth-subtitle">Join VolleyMetric and start managing tournaments</p>
                </div>
                ...
                <form action="RegisterUser" method="POST" class="auth-form">
