...
<head>
    ...
    <style>
        ...
        .profile-role { font-size: 0.85rem; color: #ff6b6b; font-weight: 600; }
        ...
        .btn-primary { background: #ff6b6b; color: #fff; flex: 1; }
        .btn-primary:hover {
            background: #ee5a52;
