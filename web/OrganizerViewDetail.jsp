...
<head>
    ...
    <style>
        ...
        .detail-section { padding: 4rem 0; background-color: #f8f9fa; min-height: 80vh; }
        .detail-container { max-width: 1200px; margin: 0 auto; }
        
        .tournament-header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 2rem; border-radius: 10px; margin-bottom: 2rem; }
        .tournament-title { font-size: 2rem; margin-bottom: 1rem; }
        .tournament-meta { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; }
        ...
        .section-title { font-size: 1.8rem; color: #1a1a2e; margin: 2rem 0 1rem; }
        
        .registrations-list { display: flex; flex-direction: column; gap: 1.5rem; }
        .registration-card { background: white; border-radius: 10px; padding: 1.5rem; box-shadow: 0 4px 15px rgba(0,0,0,0.08); }
        .card-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; border-bottom: 2px solid #f0f0f0; padding-bottom: 1rem; }
        .team-name { font-size: 1.3rem; font-weight: 700; color: #1a1a2e; }
        
        .status-badge { padding: 0.4rem 0.8rem; border-radius: 20px; font-size: 0.85rem; font-weight: 600; color: white; }
        .badge-pending { background-color: #f39c12; }
        .badge-approved { background-color: #27ae60; }
        .badge-rejected { background-color: #e74c3c; }
        
        .members-table { width: 100%; margin: 1rem 0; }
        .members-table th { background-color: #f8f9fa; padding: 0.8rem; text-align: left; font-weight: 600; border-bottom: 2px solid #e0e0e0; }
        .members-table td { padding: 0.8rem; border-bottom: 1px solid #f0f0f0; }
        
        .action-buttons { display: flex; gap: 1rem; margin-top: 1rem; }
        .btn-approve { background-color: #27ae60; color: white; padding: 0.6rem 1.5rem; border: none; border-radius: 5px; font-weight: 600; cursor: pointer; }
        .btn-reject { background-color: #e74c3c; color: white; padding: 0.6rem 1.5rem; border: none; border-radius: 5px; font-weight: 600; cursor: pointer; }
        .btn-approve:hover { background-color: #229954; }
        .btn-reject:hover { background-color: #c0392b; }
        
        .no-registrations { text-align: center; padding: 3rem; background: white; border-radius: 10px; }
    </style>
</head>
<body>
    <header class="header">
