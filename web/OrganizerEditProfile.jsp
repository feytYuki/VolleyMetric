...
<%
    ...
    if (pwErrorMsg   != null) session.removeAttribute("pwError");
    if (pwSuccessMsg != null) session.removeAttribute("pwSuccess");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        .form-input[readonly] { background: #f9f9f9; color: #888; cursor: not-allowed; }
        .input-hint { font-size: 0.78rem; color: #aaa; }
        ...
        .alert { padding: 0.9rem 1rem; border-radius: 6px; margin-bottom: 1.25rem; font-size: 0.95rem; }
        .alert-error   { background: #fee; border: 1px solid #fcc; color: #c33; }
        .alert-success { background: #efe; border: 1px solid #cfc; color: #2a2; }
        .password-section h3 { font-size: 1rem; color: #1a1a2e; margin-bottom: 1rem; }
...
<body style="min-height:100vh; display:flex; flex-direction:column; background:#f5f5f5;">
    ...
    <section class="profile-section">
        <div class="profile-card">
            ...
            <!-- ── Profile Info Form ── -->
            <form action="UpdateOrganizerProfile" method="POST">
                ...
                <div class="btn-row">
                    <a href="OrganizerProfile.jsp" class="btn btn-ghost">← Cancel</a>
            ...
            <div class="password-section">
                ...
                <form action="UpdateOrganizerPassword" method="POST">
                    <div class="form-group">
