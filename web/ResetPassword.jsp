...
<head>
    ...
    <title>Reset Password - VolleyMetric</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo-icon { font-size: 1.5rem; font-weight: bold; }
        ...
        .auth-title { font-size: 1.8rem; color: #1a1a2e; margin-bottom: 0.5rem; }
        .auth-subtitle { color: #666; font-size: 0.95rem; }
        .user-badge {
        ...
        .password-wrapper .form-input { padding-right: 2.8rem; width: 100%; box-sizing: border-box; }
        .toggle-password {
            position: absolute; right: 0.8rem; top: 50%; transform: translateY(-50%);
            background: none; border: none; cursor: pointer; padding: 0; color: #888; display: flex; align-items: center;
        }
        ...
        .btn-primary:hover { background-color: #ee5a52; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(255,107,107,0.3); }
        .back-link { text-align: center; margin-top: 1.5rem; }
        .back-link a { color: #667eea; text-decoration: none; font-size: 0.9rem; font-weight: 500; }
        ...
        .alert-error { background-color: #ffe0e0; color: #c0392b; border: 1px solid #f5c6cb; }
    </style>
</head>
<body>
    <header class="header">
