...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .badge-cancelled {
                background: linear-gradient(135deg, #636e72, #4a4a4a);
            }
            ...
            .other-tab-btn.active-live      {
                background: linear-gradient(135deg, #ff6b6b, #ee5a52);
                color: white;
            }
            .other-tab-btn.active-upcoming  {
                background: linear-gradient(135deg, #667eea, #764ba2);
                color: white;
            }
            .other-tab-btn.active-completed {
                background: linear-gradient(135deg, #95a5a6, #7f8c8d);
                color: white;
            }
            .other-tab-btn.active-live .count-badge,
            .other-tab-btn.active-upcoming .count-badge,
            .other-tab-btn.active-completed .count-badge {
                background: rgba(255,255,255,0.3);
                color: white;
            }
            .other-tab-btn:not(.active-live):not(.active-upcoming):not(.active-completed):hover {
                background: #f5f5f5;
                color: #333;
            }
