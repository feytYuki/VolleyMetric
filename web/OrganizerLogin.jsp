...
<head>
    ...
    <title>Organizer Login - VolleyMetric</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="auth-container">
            <div class="auth-card">
                <div class="auth-header">
                    <div class="organizer-badge">🎯 Organizer Portal</div>
                    <h1 class="auth-title">Organizer Login</h1>
                    <p class="auth-subtitle">Login to manage your tournaments</p>
                </div>
                <% if ("1".equals(request.getParameter("resetSuccess"))) { %>
                    <div style="padding:0.9rem 1rem;border-radius:5px;margin-bottom:1.5rem;font-size:0.9rem;background-color:#d4edda;color:#155724;border:1px solid #c3e6cb;">
                ...
                <form action="OrganizerLogin" method="POST" class="auth-form">
                    ...
                    <div style="text-align:right;margin-bottom:1rem;">
                        <a href="OrganizerForgotPassword.jsp" style="color:#667eea;text-decoration:none;font-size:0.9rem;font-weight:500;">Forgot Password?</a>
                    </div>
                ...
                <div class="auth-footer">
                    <p class="auth-text">
                        ...
                        <a href="OrganizerRegister.jsp" class="auth-link">Register here</a>
                    </p>
                    <p class="auth-text" style="margin-top: 1rem;">
                        Are you a regular user? 
                        <a href="Login.jsp" class="auth-link">User Login</a>
                    </p>
                </div>
            </div>
        </div>
